...
export function HomeExperience() {
  return (
    <div className="flex min-h-[calc(100vh-4rem)] flex-col">
      <div className="shrink-0 border-b border-[var(--card-border)]/80 bg-gradient-to-b from-[var(--card)]/70 to-transparent px-4 py-10 text-center sm:py-14">
        <h1 className="text-balance font-display text-3xl font-semibold tracking-tight text-[var(--foreground)] sm:text-4xl [font-family:var(--font-fraunces),Georgia,serif]">
          South Asian Health
        </h1>
        <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-[var(--muted-foreground)]">
          Evidence-based tools and information focused on South Asian cardiometabolic health.
        </p>
      </div>

      <section
        id="home-destinations"
        className="mx-auto flex min-h-0 w-full max-w-4xl flex-1 flex-col items-stretch justify-start gap-5 px-3 py-5 pt-5 sm:gap-6 sm:px-6 sm:py-7 sm:pt-6"
